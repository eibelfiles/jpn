...
!function(){function e(e){return document.getElementById(e)}function t(e,t){return(t||document).querySelector(e)}function n(e){var t=e.split(":");return 60*+t[0]*60+60*+t[1]}const s={day:86400,hour:3600,minute:60,second:1},i=e=>{const t=new Intl.RelativeTimeFormat,n=(e=>(Date.now()-e)/1e3)(e),{value:i,unit:a}=(e=>{for(const[t,n]of Object.entries(s))if(e>=n||"second"===t)return{value:-1*Math.floor(e/n),unit:t}})(n);return t.format(i,a)};function a(e="America/Hermosillo"){let t=new Date,n=t.toLocaleTimeString([],{timeStyle:"short",timeZone:e}),s=t.toLocaleString("es",{weekday:"long",timeZone:e});return{date:t,time:n,week:s}}function o(e,t){let n="";for(const s of e.slice(0,t)){let e=s.played_at,t=new Date(1e3*e);n+=`\n        <div class="history-item" style="--his-bg: url(${s.song.art})">\n          <div class="history-meta">\n            <h3 class="history-title">${s.song.title}</h3>\n            <div class="history-artist">${s.song.artist}</div>\n            <span class="history-timeago">${i(t)}</span>\n          </div>\n        </div>\n      `}return n}function r(e,n){let s=t(".song-cover",e),i=t(".song-title",e),a=t(".song-artist",e),o=t(".song-album",e);s&&(s.src=n.art),i&&(i.innerText=n.title),a&&(a.innerText=n.artist),o&&(o.innerText=n.album)}const l=t(".player"),c=t(".player-audio");if(c&&c.dataset.src){const $=new Audio(c.dataset.src),_=t(".player-volume",c);_.addEventListener("change",(function(e){$.volume=e.currentTarget.value/100,localStorage.setItem("player_vol",$.volume)}),!1);var d=localStorage.getItem("player_vol");d&&($.volume=d,_.value=100*d);var u=t(".player-toggle",c);"mediaSession"in navigator&&(navigator.mediaSession.setActionHandler("play",(function(){m()})),navigator.mediaSession.setActionHandler("pause",(function(){y()})));var g=null;function m(){$.load(),l.classList.toggle("is-playing"),$.play(),u.innerHTML='<svg class="i i-pause" viewBox="0 0 24 24"><path d="M5 4h4v16H5Zm10 0h4v16h-4Z"></path></svg>',null==g&&function(e){e.crossOrigin="anonymous";const t=new AudioContext,n=t.createMediaElementSource(e),s=t.createAnalyser();n.connect(s),n.connect(t.destination);const i=new Uint8Array(s.frequencyBinCount);s.getByteFrequencyData(i);const a=document.querySelector(".visualizer");for(let e=0;e<20;e++){const t=document.createElement("DIV");t.setAttribute("id","bar"+e),t.setAttribute("class","visualizer-item"),a.appendChild(t)}!function e(){s.getByteFrequencyData(i);for(let e=0;e<20;e++){const t=i[2*(e+10)],n=document.querySelector("#bar"+e);if(!n)continue;const s=Math.max(4,t||0);n.style.height=s+"px"}window.requestAnimationFrame(e)}()}($),g="init visualizer"}function y(){l.classList.toggle("is-playing"),$.pause(),u.innerHTML='<svg class="i i-play" viewBox="0 0 24 24"><path d="m7 3 14 9-14 9z"></path></svg>'}u.addEventListener("click",(()=>{$.paused?m():y()}),!1)}const p="https://stream.radioani.me/api/nowplaying_static/japanisu.json",v=e("playerHistory");!function e(){fetch(p).then((e=>e.json())).then((n=>{let s=n.song_history,i=t(".song-now",l),a=t(".song-next",l),c=n.now_playing.remaining,d=t(".player-poster");d&&d.src&&(d.crossOrigin="Anonymous",d.src="https://images.weserv.nl/?url="+encodeURIComponent(n.now_playing.song.art),Defer.js("https://cdn.jsdelivr.net/gh/lokesh/color-thief@2/dist/color-thief.umd.js","color-polyfill",0,(function(){!function(e,t){let n=new ColorThief;t.complete?e.setAttribute("style",`--accent: rgb(${n.getColor(t)})`):t.addEventListener("load",(function(){e.setAttribute("style",`--accent: rgb(${n.getColor(t)})`)}))}(document.body,d)}))),i&&r(i,n.now_playing.song),a&&r(a,n.playing_next.song);var u=b.classList.contains("is-active")?15:4;v&&(b.onclick=()=>{b.classList.remove("is-active"),S.classList.remove("has-history"),v.innerHTML=o(s,4),x.innerText="Ver más"},x.onclick=()=>{b.classList.contains("is-active")?(b.classList.remove("is-active"),S.classList.remove("has-history"),v.innerHTML=o(s,4),x.innerText="Ver más"):(b.classList.add("is-active"),S.classList.add("has-history"),v.innerHTML=o(s,15),x.innerText="Ver menos")},v.innerHTML=o(s,u)),"mediaSession"in navigator&&(navigator.mediaSession.metadata=new MediaMetadata({title:n.now_playing.song.title,artist:n.now_playing.song.artist,album:n.now_playing.song.album,artwork:[{src:n.now_playing.song.art,sizes:"96x96",type:"image/png"},{src:n.now_playing.song.art,sizes:"128x128",type:"image/png"},{src:n.now_playing.song.art,sizes:"192x192",type:"image/png"},{src:n.now_playing.song.art,sizes:"256x256",type:"image/png"}]})),document.querySelectorAll(".player-meta").forEach((e=>{var n=t(".song-title",e),s=n.offsetWidth,i=e.offsetWidth;e.setAttribute("style","--title-width:"+i+"px"),s>i?n.classList.add("song-very-long"):n.classList.remove("song-very-long")})),setTimeout(e,1e3*c)})).catch((e=>console.log(e)))}();const f=e("listeners");function h(e){return`\n      <div class="upcoming bg-dark shadow-xl" data-start="${e.start}" data-end="${e.end}" data-weekday="${e.day}" >\n        <img class="upcoming-image fit-image" src="${e.poster}" alt="${e.title}">\n        <div class="upcoming-data fs-7 relative py-.75 px-1.25">\n          <div class="upcoming-title fw-500 color-title nowrap">${e.title}</div>\n          <div class="upcoming-snippet fw-500 my-1">${e.snippet}</div>\n          <div class="upcoming-time">${e.start} - ${e.end}</div>\n        </div>\n      </div>\n    `}f&&function e(){fetch(p).then((e=>e.json())).then((t=>{let n=t.listeners.current;f.innerText=n,setTimeout(e,1e3*(f.dataset.update||5))})).catch((e=>console.log(e)))}();const w=e("program"),L=e("showWeeklySchedule"),x=e("showRecentlyPlayed"),b=e("closeHistory"),S=e("blog");function k(){let e=a(),t=w.querySelectorAll(".program-program"),s=n(e.time);t.forEach((t=>{if(t.dataset.week==e.week){t.querySelectorAll(".upcoming").forEach((e=>{let t=n(e.dataset.start),i=n(e.dataset.end);t<=s&&i>s?e.classList.add("is-online"):e.classList.remove("is-online")}))}}))}function T(){w.classList.add("program","grid","l:cols-7","cols-1","is-active"),w.querySelectorAll(".program-program").forEach((e=>{let t=e.dataset.week;var n,s,i;e.innerHTML=(n=currentSchedule,s=t,i="",n.forEach((e=>{e.day==s&&(i+=h(e))})),i)})),w.classList.remove("none")}w&&L.addEventListener("click",(()=>{L.classList.contains("is-active")?(L.classList.remove("is-active"),w.classList.add("none"),w.classList.remove("program","grid","l:cols-7","cols-1","is-active"),w.querySelectorAll(".program-program").forEach((e=>{e.innerHTML=""})),clearInterval(k)):(L.classList.add("is-active"),T(),k(),setInterval(k,1e4))}),!1);const A=e("renderUpcoming");function E(){let e=a();A.querySelectorAll(".upcoming").forEach((t=>{let s=(n(t.dataset.start)-n(e.time))/16+48,i=(n(t.dataset.start)-(n(e.time)-86400))/16+48;t.setAttribute("style",`transform: translateX(${t.dataset.weekday==e.week?s:i}px)`),t.classList.add("is-loaded")}))}A&&(E(),setInterval(E,2e4)),function e(){let t=a(),s=n("24:00")-n(t.time);A&&(A.innerHTML=function(e){let t=a();var n="";let s=(i=t.week,o="","lunes"==i?o="martes":"martes"==i?o="miércoles":"miércoles"==i?o="jueves":"jueves"==i?o="viernes":"viernes"==i?o="sábado":"sábado"==i?o="domingo":"domingo"==i&&(o="lunes"),o);var i,o;return e.forEach((e=>{e.day!=t.week&&e.day!=s||(n+=h(e))})),n}(currentSchedule)),E(),setTimeout(e,1e3*(0===s?10:s))}();const H=document.querySelector(".header-player");window.innerWidth>760&&function(){if(H){var e=H.offsetHeight;window.addEventListener("scroll",(function(){window.scrollY>H.offsetTop+e?(H.nextElementSibling.setAttribute("style","margin-top:"+e+"px"),H.classList.add("header-sticky","fixed","z-100","t-0","x-0")):(H.classList.remove("header-sticky","fixed","z-100","t-0","x-0"),H.nextElementSibling.removeAttribute("style"))}))}}(),t("[data-flickity]")&&Defer.js("https://cdn.jsdelivr.net/npm/flickity@2/dist/flickity.pkgd.min.js","flickity",100,null,!0),document.body.classList.remove("preload")}();